declare module 'mongoose' {
  ...
  */
  ...
  interface Model<T, TQueryHelpers = {}, TMethods = {}, TVirtuals = {}> extends NodeJS.EventEmitter, AcceptsDiscriminator {
    ...
    deleteOneWithRedis(filter?: FilterQuery<T>, options?: QueryOptions, callback?: CallbackWithoutResult): QueryWithHelpers<mongodb.DeleteResult, EnforceDocument<T, TMethods, TVirtuals>, TQueryHelpers, T>;
    deleteOneWithRedis(filter: FilterQuery<T>, callback: CallbackWithoutResult): QueryWithHelpers<mongodb.DeleteResult, EnforceDocument<T, TMethods, TVirtuals>, TQueryHelpers, T>;
    deleteOneWithRedis(callback: CallbackWithoutResult): QueryWithHelpers<mongodb.DeleteResult, EnforceDocument<T, TMethods, TVirtuals>, TQueryHelpers, T>;
    ...
    findOneWithRedis(filter?: FilterQuery<T>, projection?: any | null, options?: QueryOptions | null, callback?: Callback<EnforceDocument<T, TMethods, TVirtuals> | null>): Promise<LeanDocument<T>>;
    ...
    findOneAndUpdateWithRedis(filter: FilterQuery<T>, update: UpdateQuery<T>, options: QueryOptions & { rawResult: true }, callback?: (err: CallbackError, doc: any, res: any) => void): Promise<LeanDocument<T>>;
    findOneAndUpdateWithRedis(filter: FilterQuery<T>, update: UpdateQuery<T>, options: QueryOptions & { upsert: true } & ReturnsNewDoc, callback?: (err: CallbackError, doc: T, res: any) => void): Promise<LeanDocument<T>>;
    findOneAndUpdateWithRedis(filter?: FilterQuery<T>, update?: UpdateQuery<T>, options?: QueryOptions | null, callback?: (err: CallbackError, doc: T | null, res: any) => void): Promise<LeanDocument<T>>;
